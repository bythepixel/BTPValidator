...
namespace Bytepath\Shared\Testing;
...
class TestCase extends PHPUnitTestCase
{
    ...
    {
        $DBCollectionClass = "Illuminate\Database\Eloquent\Collection";
        $collectionClass = "Illuminate\Support\Collection";
        $this->assertTrue((bool) ((get_class($item) == $collectionClass) || (get_class($item) == $DBCollectionClass)));
    }
